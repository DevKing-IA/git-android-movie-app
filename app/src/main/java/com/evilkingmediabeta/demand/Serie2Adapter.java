...
public class Serie2Adapter extends RecyclerView.Adapter<Serie2Adapter.myview> implements Filterable {
    private List<Serie2Model> sportEmbedScrapeModels;
    private List<Serie2Model> sportEmbedScrapeModelsFiltered;
    ...
    public Serie2Adapter(List<Serie2Model> sportEmbedScrapeModels, Context context) {
    ...
    @NonNull
    @Override
    public Serie2Adapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.livetv_list, parent, false);

        return new Serie2Adapter.myview(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final Serie2Adapter.myview holder, final int position) {

        Serie2Model model = sportEmbedScrapeModels.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.equals("")) {
                    ...
                    List<Serie2Model> filteredList = new ArrayList<>();
                    for (Serie2Model row : sportEmbedScrapeModelsFiltered) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                sportEmbedScrapeModels = (ArrayList<Serie2Model>) filterResults.values;
