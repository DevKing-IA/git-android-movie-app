...
public class SportsEmbedScrapeAdapter extends RecyclerView.Adapter<SportsEmbedScrapeAdapter.myview> implements Filterable {
    private List<SportEmbedScrapeModel> sportEmbedScrapeModels;
    private List<SportEmbedScrapeModel> sportEmbedScrapeModelsFiltered;
    ...
    public SportsEmbedScrapeAdapter(List<SportEmbedScrapeModel> sportEmbedScrapeModels, Context context) {
    ...
    @NonNull
    @Override
    public SportsEmbedScrapeAdapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.livetv_list, parent, false);

        return new SportsEmbedScrapeAdapter.myview(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final SportsEmbedScrapeAdapter.myview holder, final int position) {

        SportEmbedScrapeModel model = sportEmbedScrapeModels.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.equals("")) {
                    ...
                    List<SportEmbedScrapeModel> filteredList = new ArrayList<>();
                    for (SportEmbedScrapeModel row : sportEmbedScrapeModelsFiltered) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                sportEmbedScrapeModels = (ArrayList<SportEmbedScrapeModel>) filterResults.values;
